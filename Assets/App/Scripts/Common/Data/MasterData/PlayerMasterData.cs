...
{
    [CreateAssetMenu(fileName = "PlayerMasterData", menuName = "MasterData/PlayerMasterData")]
    public class PlayerMasterData : ScriptableObject, ISerializationCallbackReceiver
    {
